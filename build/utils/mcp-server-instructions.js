...
export const MCP_SERVER_INSTRUCTIONS = [
    ...
    "Zephyr Scale (Tests.jspa, *-Tnnn keys, test cases/runs): use tools in this server only.",
    "Never WebFetch or curl Tests.jspa URLs — UI needs an authenticated Jira browser session (anonymous HTTP returns 503).",
