...
const buildAuthHeaders = (config: JiraConfig): Record<string, string> => {
...
export const createZephyrTestsClient = (config: JiraConfig): AxiosInstance =>
    axios.create({
...
export const createConfiguredZephyrTestsClient = (): AxiosInstance =>
    createZephyrTestsClient(getJiraConfig());
