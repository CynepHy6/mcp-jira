...
export const inspectZephyrProjectSchema = {
    projectKey: z
        .string()
        .describe(
            'Zephyr projectKey used in test-wdio --qaseProject (e.g. "PROJ"). Call this before creating new cases in an unfamiliar project.',
        ),
    sampleSize: z
        .number()
        .default(20)
...
export const inspectZephyrProjectHandler =
