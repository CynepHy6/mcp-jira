...
export const deleteZephyrFolderSchema = {
    ...
    confirm: z
        .literal(true)
        .describe(
            "Must be true. Destructive: permanently deletes the folder. Run get-zephyr-folder-tree first to confirm the id and that it is empty.",
        ),
};

// Deletes a folder via the internal /rest/tests/1.0 API (zephyrTests client).
// The public ATM API has no folder-delete endpoint.
export const deleteZephyrFolderHandler =
