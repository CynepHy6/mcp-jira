...
export const searchZephyrTestCasesSchema = {
    projectKey: z
        ...
        .optional()
        .describe(
            'Zephyr project key (e.g. "PROJ"). Required unless raw query is provided.',
        ),
    text: z
        .string()
        .optional()
    ...
    query: z
        ...
        .optional()
        .describe(
            'Raw Zephyr IQL-like query. If set, overrides projectKey/text builder. Example: projectKey = "PROJ" AND text ~ "login"',
        ),
    maxResults: z
        .number()
        .default(20)
...
export const searchZephyrTestCasesHandler =
    ...
    async ({
        ...
        try {
            ...
            const response = await zephyr.post<ZephyrTestCaseSummary[]>(
                "/testcase/search",
                {
